...
***This README is for Linux and MacOS users.*** For Windows users - please read [README.md](README.md).
...
```bash
pip3 install --upgrade https://github.com/pavel-lechenko/gimme-aws-creds-win.git
```
